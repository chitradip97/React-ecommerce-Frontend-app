...
//  }
    ...
    //                                             <td><NavLink to='update'><button class="btn btn-success"
    ...
    //     </>
    //  );
    const [catposition,setcatposition]=useState(true);
    if(catposition==true){
        return (
            <Category_list setcatposition={setcatposition}/>
        )
    }
    else{
        return(
            <Category_edit setcatposition={setcatposition}/>
        )
    }
}
